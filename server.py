    ...
    def do_POST(self):
        ...
        if path == '/api/analytics':
            ...
            try:
                ...
                c.execute('INSERT INTO email_queue (to_email, subject, body) VALUES (?, ?, ?)', (email, visitor_subject, visitor_body))
                ...
                c.execute('INSERT INTO email_queue (to_email, subject, body) VALUES (?, ?, ?)', (ADMIN_EMAIL, admin_subject, admin_body))
